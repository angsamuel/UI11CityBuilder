...
public class ConnectBuilding : Building
{
    ...
    public void ConnectToNeighbors(bool from_master){
        List<Building> nsew_buildings = terrain_generator.GetNSEWBuildings(x_coord,z_coord);
        List<TerrainCube> surface_blocks = terrain_generator.GetNSEWSurfaceBlocks(x_coord,z_coord);
        if(surface_blocks[0] == null || nsew_buildings[0] != null && nsew_buildings[0].building_name == building_name){
            north_object.SetActive(true);
            if(from_master && nsew_buildings[0] != null){
                nsew_buildings[0].GetComponent<ConnectBuilding>().ConnectToNeighbors(false);
            }
        }
        if(surface_blocks[1] == null || nsew_buildings[1] != null && nsew_buildings[1].building_name == building_name){
            south_object.SetActive(true);
            if(from_master && nsew_buildings[1] != null){
        ...
        if(surface_blocks[2] == null || nsew_buildings[2] != null && nsew_buildings[2].building_name == building_name){
            ...
            if(from_master && nsew_buildings[2] != null){
        ...
        if(surface_blocks[3] == null || nsew_buildings[3] != null && nsew_buildings[3].building_name == building_name){
            ...
            if(from_master && nsew_buildings[3] != null){
